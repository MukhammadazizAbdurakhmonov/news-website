          ...
          <div class="col-md-10">
              ...
              <form class="needs-validation border p-2" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" name="news_title" id="newsTitle" value="<?php echo $data['news']->news_title; ?>">
                </div>

                <!-- News content -->
                <div class="mb-3">
                    <label for="newsContent" class="form-label">News content</label>
                    <textarea class="form-control" name="news_content" id="newsContent"><?php echo $data['news']->news_content; ?></textarea>
                </div>
                ...
                <!-- News image -->
                <div><img src="<?php echo URLROOT; ?>/images/<?php echo $data['news']->news_image; ?>" style="width: 256px;"></div>
