    ...
    <div class="container">
        <div class="row">
            <div class="col">
                ...
                <h1>Create news</h1>
                <form action="<?php echo URLROOT;?>/news/create" class="needs-validation border p-2" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="newsTitle" class="form-label">News title</label>
                        <input type="text" name="news_title" class="form-control" id="newsTitle" placeholder="News title">
                    </div>

                    <div class="mb-3">
                        <label for="newsContent" class="form-label">News content</label>
                        <textarea class="form-control" name="news_content" id="newsContent" placeholder="News content"></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" name="news_image" type="file" id="newsImage">
                    </div>
