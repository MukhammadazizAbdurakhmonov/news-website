<?php include dirname(__DIR__, 1).'/includes/header.php'; ?>
    ...
    <div class="container">
        ...
        <?php include dirname(__DIR__, 1).'/includes/tables.php'; ?>
            ...
            <div class="col-md-10">
              <a href="<?php echo URLROOT; ?>/news/create" class="btn btn-primary float-end mb-2">Create</a>
                <h1>News</h1>
                ...
                <table class="table caption-top table-bordered">
                  ...
                  <?php foreach($data['news'] as $news): ?>
                    <tr>
                      ...
                      <td>
                        <form action="<?php echo URLROOT; ?>/news/delete/<?php echo $news->id; ?>" class="d-inline" method="post">
                          <button class="btn btn-sm btn-danger"><i class="fa-solid fa-trash"></i> Delete</button>
                        </form>
                        <a href="<?php echo URLROOT; ?>/news/edit/<?php echo $news->id; ?>" class="btn btn-sm btn-secondary"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                        <a href="<?php echo URLROOT; ?>/news/show/<?php echo $news->id; ?>" class="btn btn-sm btn-success"><i class="fa-solid fa-eye"></i> Show</a>
                      </td>
                    </tr>
                    <?php endforeach; ?>
                  </tbody>
