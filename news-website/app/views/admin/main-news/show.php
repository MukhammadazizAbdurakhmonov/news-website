            ...
            <a href="<?php echo URLROOT;?>/news/index" class="btn btn-primary float-end">Back</a>
              <table class="table caption-top table-bordered">
                    ...
                    <tr>
                        ...
                        <td><?php echo $data['news']->main_news_title; ?></td>
                    </tr>
                    <tr>
                        <th class="col">News content:</th>
                        <td><?php echo $data['news']->main_news_content; ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo URLROOT; ?>/images/<?php echo $data['news']->main_news_image; ?>" style="width: 256px;"></td>
                    </tr>
                </table>
            </div>
        </div>
