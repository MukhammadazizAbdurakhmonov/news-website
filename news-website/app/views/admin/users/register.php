...
<body>
    ...
    <div class="container col-md-6 mt-5">
        ...
        <div class="row">
            <div class="col">
                <form action="<?php echo URLROOT; ?>/auth/register" class="needs-validation border p-2" method="post">
                    <div class="mb-3">
                        <label for="articleTitle" class="form-label">Name</label>
                        <input name="name" type="text" class="form-control" id="formGroupExampleInput" placeholder="Name" value="<?php echo empty($data['name']) ? '': $data['name']; ?>" htmlcharac>
                        <div class="text-danger">
                            <?php echo !empty($data['errors']['name_error']) ? $data['errors']['name_error'] : '';?>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="articleTitle" class="form-label">Confirm password</label>
                        <input name="confirm_password" type="password" class="form-control" id="formGroupExampleInput" placeholder="Confirm passwrod" value="<?php echo empty($data['confirm_password']) ? '': $data['confirm_password']; ?>">
                        <div class="text-danger">
                            <?php echo !empty($data['errors']['confirm_password_error']) ? $data['errors']['confirm_password_error'] : '';?>
                        </div>
                    </div>
                    <div>
